...
public class GvrArmModel : MonoBehaviour {
  ...
  private static readonly Vector3 WRIST_POSITION = new Vector3(0.2f, 0.0f, 0.25f); //x position changed from 0 to 0.2
  ...
  private void ApplyArmModel() {
    ...
    elbowPosition = ELBOW_POSITION + new Vector3(0.2f, addedElbowHeight, addedElbowDepth);  // x changed form 0.0f to 0.2f
